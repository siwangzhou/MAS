...
from method2.uniontrain.method2_union_net_val import EDSR_union2_val
...
#采样率分配
    ...
    # index=block_x2[3]
    index=35
    # cv2.imwrite('F:\BMDS_output\MultiLevelBMDSR\EDSR_test4k/' + imgname, i1*255)
    i1 = cv2.cvtColor(i1, cv2.COLOR_RGB2BGR)
    ...
    # distance1 = lpips_model(source.cuda(), img1.cuda())
